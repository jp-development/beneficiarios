...
use App\Http\Livewire\Admin\Regionals\Create as RegionalsCreate;
use App\Http\Livewire\Admin\Regionals\Index as RegionalsIndex;
...
Route::get('regionals', RegionalsIndex::class);
Route::get('regionals/create', RegionalsCreate::class);