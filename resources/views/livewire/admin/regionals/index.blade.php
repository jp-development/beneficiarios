    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-6 bg-white shadow-lg rounded-md p-5 row-span-1">
            ...
            <div class="flex justify-between items-center w-full">
                <form wire:submit.prevent='createZonalCenter' class="w-full flex flex-col justify-between items-center">
                    <input type="text" class="my-2 border rounded-md shadow-sm w-full p-2 focus:outline-principal" wire:model.lazy='nameZonalCenter'>
                    <label class="text-base font-bold w-full text-left">Regional perteneciente</label>
                    <div class="w-full" >
                        <select class="mb-2 border rounded-md shadow-sm w-full p-2 bg-white focus:outline-principal" wire:model.lazy='regionalId' >
                            <option></option>
                    ...
                    <button type="submit" class=" m-2 p-2 bg-principal rounded-lg text-white font-bold w-full">Crear
                        nuevo
                        centro zonal</button>
                </form>
            </div>
        ...
        <div class="col-span-6 bg-white shadow-lg rounded-md p-5">
            ...
            <table class="min-w-full">
                ...
                <tbody>
                    @forelse ($getZonalCenters as $item)
                        <tr>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500">
                                <div class="flex items-center">
                                    {{ $item->id }}
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500">
                                <div class="text-sm leading-5 text-blue-900">
                                    <button
                                        class="p-2 text-white font-bold bg-red-600 rounded hover:bg-red-500 w-full flex justify-center"
                                        wire:click.prevent='$emit("deleteZonalCenter", {{ $item->id }})'> 
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            viewBox="0 0 512 512">
                                            <path
                                            ...
                                            <line x1="328" y1="176" x2="320" y2="400"
                                                style="fill:none;stroke:#fff;stroke-linecap:round;stroke-linejoin:round;stroke-width:32px" />
                                        </svg>Eliminar centro zonal</button>
                                </div>
                            </td>
                        </tr>
                    @empty
    ...
    @section('js')
        <script>
            ...
            $(document).ready(function() {
                $('#regional').select2({
                    placeholder: 'Elija la regional a la que pertenece este centro zonal'
                });
            });
            ...
            Livewire.on('zonalCenterCreated', message => {
                Swal.fire({
                    icon: 'success',
                    title: message,
                    showConfirmButton: false,
            ...
            Livewire.on('deleteZonalCenter', id => {
                Swal.fire({
                    title: 'Esta seguro?',
                    text: "Esto no se podra revertir",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        Livewire.emitTo('admin.regionals.index', 'deleteZonalCenters', id)
                        Swal.fire(
                            'Eliminado!',
                            'La regional fue eliminada con exito',
                            'success'
